...
find_next_op(array_s *op_list, fds_filter_op_s *prev, const char *symbol, int out_dt, int arg1_dt, int arg2_dt)
{
    ARRAY_FOR_CONTINUE(op_list, prev, fds_filter_op_s *, o) {
...
static inline fds_filter_op_s *
find_op(array_s *op_list, const char *symbol, int out_dt, int arg1_dt, int arg2_dt)
{
    return find_next_op(op_list, NULL, symbol, out_dt, arg1_dt, arg2_dt);
}

static inline fds_filter_op_s *
find_next_binary_op(array_s *op_list,
...
static inline fds_filter_op_s *
find_binary_op(array_s *op_list, const char *symbol, int arg1_dt, int arg2_dt)
{
    return find_next_op(op_list, NULL, symbol, DT_ANY, arg1_dt, arg2_dt);
}

static inline fds_filter_op_s *
find_next_unary_op(array_s *op_list, fds_filter_op_s *prev, const char *symbol, int arg1_dt)
{
    return find_next_op(op_list, prev, symbol, DT_ANY, arg1_dt, DT_NONE);
}

static inline fds_filter_op_s *
find_unary_op(array_s *op_list, const char *symbol, int arg1_dt)
{
    return find_next_op(op_list, NULL, symbol, DT_ANY, arg1_dt, DT_NONE);
}

static inline fds_filter_op_s *
find_next_cast(array_s *op_list, fds_filter_op_s *prev, int from_dt)
{
    return find_next_op(op_list, prev, "__cast__", DT_ANY, from_dt, DT_NONE);
}

static inline fds_filter_op_s *
find_cast(array_s *op_list, int from_dt, int to_dt)
{
    return find_next_op(op_list, NULL, "__cast__", to_dt, from_dt, DT_NONE);
}

static inline bool
can_cast(array_s *op_list, int from_dt, int to_dt)
{
...
static inline fds_filter_op_s *
find_constructor(array_s *op_list, int from_dt, int to_dt)
{
...
static inline fds_filter_op_s *
find_destructor(array_s *op_list, int datatype)
{
